    ...
    def get(self, request):
        ...
        return Response({
            ...
            "bills": {
                ...
                "unpaid_count":      sum(1 for b in all_bills if b.payment_status == "UNPAID"),
                "partial_count":     sum(1 for b in all_bills if b.payment_status == "PARTIAL"),
                "paid_count":        sum(1 for b in all_bills if b.payment_status == "PAID"),
