...
class LoanDisbursement(models.Model):
    ...
    loan_account = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_disbursements",
        limit_choices_to={"is_loan": True},
    )
    bank_account = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_disbursement_receipts",
    ...
    journal_entry = models.OneToOneField(
        "financials.JournalEntry", on_delete=models.PROTECT, null=True, blank=True,
...
class LoanEMIPayment(models.Model):
    ...
    id              = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    loan_account    = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_emi_payments",
        limit_choices_to={"is_loan": True},
    )
    bank_account    = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_emi_sources",
        limit_choices_to={"is_bank": True},
