...
class Bill(models.Model):
    ...
    expense_account = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_bills",
        limit_choices_to={"account_type": "EXPENSE"},
    )
    # Liability account (Accounts Payable)
    payable_account = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_payable_bills",
...
class BillItem(models.Model):
    ...
    budget_category = models.ForeignKey(
        ...
        null=True, blank=True, related_name="fin_bill_items",
    )

    class Meta:
        app_label = "financials"
        db_table  = "fin_billitem"
...
class BillPayment(models.Model):
    ...
    bank_account  = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_bill_payments",
