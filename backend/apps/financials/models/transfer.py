...
class CashTransfer(models.Model):
    ...
    from_account = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_transfers_out",
        help_text="Account money leaves (will be CREDITED)",
    )
    to_account   = models.ForeignKey(
        "financials.Account", on_delete=models.PROTECT, related_name="fin_transfers_in",
