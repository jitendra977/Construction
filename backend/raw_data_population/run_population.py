...
def run_all():
    script_names = [
        ...
        '11_finance_expenses', '12_permits', '13_estimator_rates', '14_resource_transactions', '15_deep_interactions', '16_phase_budget_allocations', '17_wastage_data', '98_verify_funding'
    ]
    ...
    for name in script_names:
        ...
        try:
            ...
            module = __import__(f'raw_data_population.{name}', fromlist=['populate'])
            module.populate()
