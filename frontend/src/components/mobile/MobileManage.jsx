/**
 * MobileManage — Management Hub (mobile).
 *
 * Identical layout to DesktopManage: system status bar, module cards grid,
 * and quick-link to PhasesPage. Uses mobile navigation paths throughout.
 */
import React, { useMemo } from 'react';
import { useNavigate } from 'react-router-dom';
import { useConstruction } from '../../context/ConstructionContext';
import MobileLayout from './MobileLayout';
import ManagementTabs from '../desktop/manage/ManagementTabs';
...
const MobileManage = () => {
    ...
    const stats = useMemo(() => {
        ...
        return { phaseDone, phaseActive, taskDone, taskActive, taskOverdue, totalSpent, totalBudget, lowStock, roomDone };
    ...
    const modules = [
        {
            ...
            color: '#3b82f6', path: `${BASE}/timeline`,
            ...
            actions: [
                { label: '📊 Gantt',  path: `${BASE}/timeline` },
                { label: '🗂️ Kanban', path: `${BASE}/timeline` },
            ],
        },
        {
            icon: '💰', title: 'Finance', subtitle: 'Budget · Expenses · Ledger',
            color: '#10b981', path: `${BASE}/finance`,
            ...
            actions: [
                { label: '💸 Expenses', path: `${BASE}/finance` },
                { label: '📒 Ledger',   path: `${BASE}/finance` },
            ],
        },
        {
            icon: '🧱', title: 'Resources', subtitle: 'Materials · Contractors · Stock',
            color: '#f97316', path: `${BASE}/resource`,
            ...
            actions: [
                { label: '📦 Materials',   path: `${BASE}/resource` },
                { label: '👷 Contractors', path: `${BASE}/resource` },
            ],
        },
        {
            icon: '🏛️', title: 'Structure', subtitle: 'Floors · Rooms · Layout',
            color: '#8b5cf6', path: `${BASE}/structure`,
            stats: [
            ...
            actions: [
                { label: '🗺️ Floor Plan', path: `${BASE}/structure` },
            ],
        },
        {
            icon: '📜', title: 'Permits', subtitle: 'Municipal · Approvals',
            color: '#06b6d4', path: `${BASE}/permits`,
            ...
            actions: [
                { label: '📋 View All', path: `${BASE}/permits` },
            ],
        },
        {
            icon: '📈', title: 'Analytics', subtitle: 'Reports · Charts · Insights',
            color: '#f59e0b', path: `${BASE}/analytics`,
            stats: [
            ...
            actions: [
                { label: '📊 Open Reports', path: `${BASE}/analytics` },
            ],
        },
        {
            icon: '📸', title: 'Gallery', subtitle: 'Photos · Timelapse · Docs',
            color: '#ec4899', path: `${BASE}/photos`,
            stats: [
            ...
            actions: [
                { label: '📷 Photos',    path: `${BASE}/photos` },
                { label: '🎞️ Timelapse', path: `${BASE}/timelapse` },
            ],
        },
        {
            icon: '⚙️', title: 'Settings', subtitle: 'Users · Import · Guides',
            color: '#6b7280', path: `${BASE}/guides`,
            stats: [
            ...
            actions: [
                { label: '📥 Import', path: `${BASE}/import` },
                { label: '📚 Guides', path: `${BASE}/guides` },
            ],
        },
    ];
    ...
    return (
        <MobileLayout>
            <div style={{ minHeight: '100vh', background: 'var(--t-bg)', paddingBottom: 96 }}>
                <ManagementTabs />
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                        ...
                        <button onClick={() => navigate(`${BASE}/projects`)} style={{
                            padding: '7px 14px', borderRadius: 8, fontSize: 12, fontWeight: 700,
