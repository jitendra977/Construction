...
export default function LaborPage() {
  ...
  return (
    <div style={{ padding: isMobile ? '8px 0 16px' : '20px 0' }}>
      ...
      <div style={{ 
        ...
        <div>
          <h1 style={{ margin:0, fontSize:isMobile ? 18 : 22, fontWeight:900, color:'var(--t-text)' }}>Workforce Hub</h1>
          <p style={{ margin:'4px 0 0', fontSize:13, color:'var(--t-text3)' }}>Administration of personnel and team structures.</p>
        </div>

        <div style={{ display:'flex', gap:4, background:'var(--t-surface2)', padding:4, borderRadius:12, border:'1px solid var(--t-border)', width: isMobile ? '100%' : 'auto' }}>
          {[
